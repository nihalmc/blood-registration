            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="address" id="" value="<?= $donor['address']; ?>" class="form-control">
                    </div>
                    <div class="mb-3">
                        <label>Blood Group</label>
                        <input type="text" name="bloodgroup" id="" value="<?= $donor['bloodgroup']; ?>" class="form-control">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label>Date</label>
                        <input type="text" name="date" id="" value="<?= $donor['date']; ?>" class="form-control">
                    </div>
                    <div class="mb-3">
